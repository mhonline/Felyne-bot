	...
	module Commands
		module Raid
			...
			command(
				...
				name1 = getline("bot/raid1",1)
				name2 = getline("bot/raid2",1)
				name3 = getline("bot/raid3",1)
				name4 = getline("bot/raid4",1)
				name5 = getline("bot/raid5",1)
