module FelyneBot
	module Commands
		module Raid5
			...
			command(:raid5, description: 'Schedules Raid 5. (Name has to be a single word)', usage: '-raid5 <name> <days> <hours> <minutes> | raid5 clear', permission_level: 1, permission_message: "Ask a Mod or Admin to set up a raid!") do |event, name, days, hours, minutes|
				d = days.to_i
				h = hours.to_i
				m = minutes.to_i
				t1 = Time.now
