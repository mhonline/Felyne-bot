module FelyneBot
	module Commands
		module Raid5
			...
			command(:raid5, description: 'Schedules Raid 5. (Name has to be a single word)', usage: 'raid5 <name> <hours> <minutes> | raid5 clear', permission_level: 1) do |event, name, hours, minutes|
				h = hours.to_i
				m = minutes.to_i
				now = Time.now
				now = now.to_i
