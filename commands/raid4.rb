module FelyneBot
	module Commands
		module Raid4
			...
			command(:raid4, description: 'Schedules Raid 4. (Name has to be a single word)', usage: 'raid4 <name> <hours> <minutes> | raid4 clear', permission_level: 1) do |event, name, hours, minutes|
				h = hours.to_i
				m = minutes.to_i
				now = Time.now
				now = now.to_i
