module FelyneBot
	module Commands
		module Raid4
			...
			command(:raid4, description: 'Schedules Raid 4. (Name has to be a single word)', usage: '-raid4 <name> <days> <hours> <minutes> | raid4 clear', permission_level: 1, permission_message: "Ask a Mod or Admin to set up a raid!") do |event, name, days, hours, minutes|
				d = days.to_i
				h = hours.to_i
				m = minutes.to_i
				t1 = Time.now
