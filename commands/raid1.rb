module FelyneBot
	module Commands
		module Raid1
			...
			command(:raid1, description: 'Schedules Raid 1. (Name has to be a single word)', usage: 'raid1 <name> <hours> <minutes> | raid1 clear', permission_level: 1) do |event, name, hours, minutes|
				h = hours.to_i
				m = minutes.to_i
				now = Time.now
				now = now.to_i
