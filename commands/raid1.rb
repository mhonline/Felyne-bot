module FelyneBot
	module Commands
		module Raid1
			...
			command(:raid1, description: 'Schedules Raid 1. (Name has to be a single word)', usage: '-raid1 <name> <days> <hours> <minutes> | raid1 clear', permission_level: 1, permission_message: "Ask a Mod or Admin to set up a raid!") do |event, name, days, hours, minutes|
				d = days.to_i
				h = hours.to_i
				m = minutes.to_i
				t1 = Time.now
