module FelyneBot
	module Commands
		module Raid3
			...
			command(:raid3, description: 'Schedules Raid 3. (Name has to be a single word)', usage: 'raid3 <name> <hours> <minutes> | raid3 clear', permission_level: 1) do |event, name, hours, minutes|
				h = hours.to_i
				m = minutes.to_i
				now = Time.now
				now = now.to_i
