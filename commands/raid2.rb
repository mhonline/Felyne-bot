module FelyneBot
	module Commands
		module Raid2
			...
			command(:raid2, description: 'Schedules Raid 2. (Name has to be a single word)', usage: 'raid2 <name> <hours> <minutes> | raid2 clear', permission_level: 1) do |event, name, hours, minutes|
				h = hours.to_i
				m = minutes.to_i
				now = Time.now
				now = now.to_i
